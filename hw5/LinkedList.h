...
public:
	...
	//LinkedList(LinkedList<T>&& e); // Move constructor
    virtual ~LinkedList(void);  // Destructor
	LinkedList<T>& operator= (const LinkedList<T> &e); //Copy assignment operator
	//LinkedList<T>& operator= (LinkedList<T> &&e); // Move assignment operator
	template<class T> friend void swap(LinkedList<T> &a,LinkedList<T> &b);
...
// Move constructor
template <class T>
LinkedList<T>::LinkedList(LinkedList<T>&& e){
	swap(this*,e);
}
*/
...
template <class T> void swap(LinkedList<T> &a,LinkedList<T>  &b){
...
template <class T> LinkedList<T>& LinkedList<T>::operator= (const LinkedList &e) 
{
	LinkedList<T> tmp(e);
	swap(*this,tmp);
    return *this;
...
template <class T>
LinkedList<T>& LinkedList<T>::operator= (LinkedList<T> &&e){
	swap(*this,e);
    return *this;
}
*/
